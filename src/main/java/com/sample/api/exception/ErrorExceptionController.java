...
public class ErrorExceptionController {
    ...
    protected ErrorResponse handleAccountNotFoundException(ResourceNotFoundException e) {
        final ErrorCode accountNotFound = ErrorCode.USER_NOT_FOUND;
    ...
    protected ErrorResponse handleConflictException(ConflictException e) {
        final ErrorCode accountNotFound = ErrorCode.USER_CONFLICT;
        log.error(accountNotFound.getMessage(), e.getId());
        return buildError(accountNotFound);
    }
